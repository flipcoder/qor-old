...
GameState::GameState(Engine* engine, TransitionInfo* trans)
{
	...
	m_pEngine = engine;
	m_pScene = new Scene("data/maps/Apartment/apartment_scene.obj", Scene::F_PHYSICS);
	...
	//Entity* e = new Entity("data/entities/glock/glock.obj",
	...
	*e->matrix() = glm::gtx::transform2::lookAt(glm::vec3(0.0f), glm::vec3(0.0, 0.0f, -1000.0f) - gunpos, Axis::Y);
	...
	particle.life = 10.0f;
	particle.vel = glm::vec3(0.0f,-1.0f,0.0f);
	particle.color.set(1.0f, 1.0f, 1.0f);
